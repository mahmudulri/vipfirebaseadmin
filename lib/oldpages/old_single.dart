...
class OldSingle extends StatefulWidget {
  const OldSingle({super.key});

  @override
  State<OldSingle> createState() => _OldSingleState();
}

class _OldSingleState extends State<OldSingle> {
  ...
  String category = "__Single Vip Success Tips";
