...
class OldFifty extends StatefulWidget {
  const OldFifty({super.key});

  @override
  State<OldFifty> createState() => _OldFiftyState();
}

class _OldFiftyState extends State<OldFifty> {
  ...
  String category = "__50+ Odds Vip Success Tips";
