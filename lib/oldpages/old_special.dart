...
class OldSpecial extends StatefulWidget {
  const OldSpecial({super.key});

  @override
  State<OldSpecial> createState() => _OldSpecialState();
}

class _OldSpecialState extends State<OldSpecial> {
  ...
  String category = "__Special Vip Success Tips";
