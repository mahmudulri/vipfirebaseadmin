...
class SureTips extends StatefulWidget {
  ...
  @override
  State<SureTips> createState() => _SureTipsState();
}

class _SureTipsState extends State<SureTips> {
  ...
  final dateData = FirebaseDatabase.instance.ref("Sure_Tips_Date");
  ...
  Widget build(BuildContext context) {
    ...
    final mydata = FirebaseDatabase.instance.ref("Sure_Tips");
