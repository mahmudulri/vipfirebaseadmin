...
class BonusTips extends StatefulWidget {
  const BonusTips({super.key});

  @override
  State<BonusTips> createState() => _BonusTipsState();
}

class _BonusTipsState extends State<BonusTips> {
  ...
  Widget build(BuildContext context) {
    ...
    final mydata = FirebaseDatabase.instance.ref("Bonus_Tips");
    final dateData = FirebaseDatabase.instance.ref("Bonus_Tips_Date");
