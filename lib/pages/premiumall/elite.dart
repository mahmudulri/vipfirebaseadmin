...
class EliteVip extends StatefulWidget {
  const EliteVip({super.key});

  @override
  State<EliteVip> createState() => _EliteVipState();
}

class _EliteVipState extends State<EliteVip> {
  ...
  final dateData = FirebaseDatabase.instance.ref("Elite_vip_date");
  ...
  Widget build(BuildContext context) {
    ...
    final mydata = FirebaseDatabase.instance.ref("Elite_vip");
