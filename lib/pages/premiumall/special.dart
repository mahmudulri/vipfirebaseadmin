...
class SpecialVip extends StatefulWidget {
  const SpecialVip({super.key});

  @override
  State<SpecialVip> createState() => _SpecialVipState();
}

class _SpecialVipState extends State<SpecialVip> {
  ...
  final dateData = FirebaseDatabase.instance.ref("Special_vip_date");
  ...
  Widget build(BuildContext context) {
    ...
    final mydata = FirebaseDatabase.instance.ref("Special_vip");
