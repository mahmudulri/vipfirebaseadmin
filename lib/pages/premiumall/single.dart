...
class SingleVip extends StatefulWidget {
  const SingleVip({super.key});

  @override
  State<SingleVip> createState() => _SingleVipState();
}

class _SingleVipState extends State<SingleVip> {
  ...
  final dateData = FirebaseDatabase.instance.ref("Single_vip_date");
  ...
  Widget build(BuildContext context) {
    ...
    final mydata = FirebaseDatabase.instance.ref("Single_vip");
