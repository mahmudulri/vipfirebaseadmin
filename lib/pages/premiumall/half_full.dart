...
class HalfFullVip extends StatefulWidget {
  const HalfFullVip({super.key});

  @override
  State<HalfFullVip> createState() => _HalfFullVipState();
}

class _HalfFullVipState extends State<HalfFullVip> {
  ...
  final dateData = FirebaseDatabase.instance.ref("Half_full_vip_date");
  ...
  Widget build(BuildContext context) {
    ...
    final mydata = FirebaseDatabase.instance.ref("Half_full_vip");
